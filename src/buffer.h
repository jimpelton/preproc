...
public:
  ...
  size_t index() const
  { return m_elementIndexOffset; }

  void index(size_t ele)
  { m_elementIndexOffset = ele; }

private:
  Ty *m_data;  ///< Ptr to memory of this buffer.
  size_t
      m_elementIndexOffset;  ///< Starting index in data stream of this buffer.
